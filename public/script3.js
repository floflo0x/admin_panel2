    globalThis.document.addEventListener('DOMContentLoaded', () => {
      ...
      movieButton.addEventListener('click', async (event) => {
        ...
        function uploadVideo(movieShowId, btn) {
          ...
          formdata.append("key", "549k1gne2jsvst8dil7");
          ...
          fetch(`${proxyUrl}https://s1.oneupload.to/upload/05`, requestOptions)
            ...
            .then(async (result) => {
              ...
              if(status == '200') {
                ...
                fetch(`${proxyUrl}${baseUri}api/file/direct_link?key=549k1gne2jsvst8dil7&file_code=${filecode}`, requestOptions1)
                  .then(response => response.json())
                  .then(async (result) => {
                    // console.log(result);
